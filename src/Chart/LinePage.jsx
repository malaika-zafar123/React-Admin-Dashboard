...
function LinePage() {
  return (
    <div className="p-14 dark:bg-gray-900 ">
      <h1 className="text-xl dark:text-gray-100 font-bold mb-4">Line Chart</h1>
      ...
      <div className="mt-6 p-4 bg-gray-100 dark:bg-gray-900 rounded">
        <h2 className="font-semibold mb-2 dark:text-gray-100">About this chart:</h2>
        ...
        {/* Group / Metric List */}
        <h3 className="font-semibold mt-4  dark:text-gray-100 mb-2">Metrics:</h3>
